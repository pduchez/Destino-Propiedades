      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="card">
          ...
          <ol className="mt-3 space-y-2 text-sm text-slate-600">
            <li>1. Define la <Link href="/acceso-ventas/settings" className="text-brand underline">estrategia de marca</Link> y tus <Link href="/acceso-ventas/projects" className="text-brand underline">proyectos</Link>.</li>
            <li>2. Sube imágenes al <Link href="/acceso-ventas/images" className="text-brand underline">stock</Link> (globales o por proyecto).</li>
            <li>3. Crea <Link href="/acceso-ventas/campaigns" className="text-brand underline">campañas</Link> con instrucciones específicas (opcional).</li>
            <li>4. <Link href="/acceso-ventas/generate" className="text-brand underline">Genera</Link> borradores para Facebook, Instagram, X y TikTok.</li>
            <li>5. Revisa y aprueba en la <Link href="/acceso-ventas/queue" className="text-brand underline">cola de aprobación</Link>; publica con un clic.</li>
            <li>6. Mide el impacto en <Link href="/acceso-ventas/metrics" className="text-brand underline">Métricas e informe</Link> y deja que ARS autoevalúe y ajuste la estrategia.</li>
          </ol>
        </div>
        <div className="card">
          ...
          <Link href="/acceso-ventas/settings" className="btn-secondary mt-4">Ir a configuración</Link>
        </div>
      </div>
    </div>
  );
